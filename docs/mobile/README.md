...
| [Components](presentation/components.md) | `Value`, component contracts, slice file layout, default implementations, events, output, or factories |
| [View models](presentation/view-models.md) | view model placement, factory, dependencies, state, cleanup, or tests |
...
| [Retention](presentation/retention.md) | `BaseViewModel`, `InstanceKeeper`, `StateKeeper`, config serialization, restoration, keys, or lifecycle tests |
