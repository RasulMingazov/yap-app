 ...
 */
internal fun SelectProviderModel.DataState.toUiState(): SelectProviderComponent.UiState {
    val rows = providers.filter(LoginProvider::isVisible).map(LoginProvider::toRow)
